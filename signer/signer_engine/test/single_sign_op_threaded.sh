...
echo ":expiration 20190701000000" >> $TMP_COMMANDS
echo ":expiration_denial 20190801000000" >> $TMP_COMMANDS
...
echo "../../tools/signer_threads -c opendnssec.xml -p signed_zones/tjeb.nl.signed -f $TMP_COMMANDS -w signed_zones/tjeb.nl.tmp"
../../tools/signer_threads -c opendnssec.xml -p signed_zones/tjeb.nl.signed -f $TMP_COMMANDS -w signed_zones/tjeb.nl.tmp
