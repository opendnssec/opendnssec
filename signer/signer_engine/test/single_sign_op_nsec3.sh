...
echo ":expiration 20200701000000" >> $TMP_COMMANDS
...
echo "Signing zone"
../../tools/zone_reader -f $TMP_ZONE -o tjeb.nl -n -t 10 -s 656d6d6b7469736169646f677461 |\
../../tools/nsec3er -t 10 -s 656d6d6b7469736169646f677461 -o tjeb.nl >> $TMP_COMMANDS
