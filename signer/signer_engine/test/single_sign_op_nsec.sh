...
echo "Adding keys"
../../tools/create_dnskey -r test -n test_token -m ../../../softHSM/src/lib/.libs/libsofthsm.so -p 1111 -o tjeb.nl -a 5 -f 257 -t 3600 fc9ead5ec20345ca87e61836ff327ce1 >> $TMP_ZONE
../../tools/create_dnskey -r test -n test_token -m ../../../softHSM/src/lib/.libs/libsofthsm.so -p 1111 -o tjeb.nl -a 5 -f 256 -t 3600 e715319b2fe146bfb4fa8e9b2c780d21 >> $TMP_ZONE
# sort, nsec, and sign it
echo "Signing zone"
../../tools/zone_reader -f $TMP_ZONE -o tjeb.nl |\
../../tools/nseccer >> $TMP_COMMANDS

../../tools/signer -f $TMP_COMMANDS -w signed_zones/tjeb.nl
