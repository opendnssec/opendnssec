...
echo -n "LINE: ${LINENO} " && ods-signer update --all && sleep 5 &&
echo -n "LINE: ${LINENO} " && ods-signer sign --all && sleep 5 &&
echo -n "LINE: ${LINENO} " && syslog_waitfor_count 540 7 'ods-signerd: .*\[STATS\] ods' &&
...
echo -n "LINE: ${LINENO} " && ods-signer update --all && sleep 5 &&
echo -n "LINE: ${LINENO} " && ods-signer sign --all && sleep 5 &&
echo -n "LINE: ${LINENO} " && syslog_waitfor_count 540 9 'ods-signerd: .*\[STATS\] ods' &&
...
echo -n "LINE: ${LINENO} " && ods-signer update --all && sleep 5 &&
echo -n "LINE: ${LINENO} " && ods-signer sign --all && sleep 5 &&
echo -n "LINE: ${LINENO} " && syslog_waitfor_count 540 10 'ods-signerd: .*\[STATS\] ods' &&
