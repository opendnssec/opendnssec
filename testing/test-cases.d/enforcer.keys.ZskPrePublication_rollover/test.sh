...
echo -n "LINE: ${LINENO} " && syslog_waitfor_count 120 1 'ods-signerd: .*\[STATS\] ods' &&
...
echo -n "LINE: ${LINENO} " && syslog_waitfor_count 120 3 'ods-signerd: .*\[STATS\] ods' &&
...
echo -n "LINE: ${LINENO} " && sleep 3 && ods-signer update --all && sleep 10 &&
echo -n "LINE: ${LINENO} " && sleep 3 && ods-signer sign --all && sleep 5 &&
echo -n "LINE: ${LINENO} " && syslog_waitfor_count 120 8 'ods-signerd: .*\[STATS\] ods' &&
...
echo -n "LINE: ${LINENO} " && sleep 3 && ods-signer update --all && sleep 10 &&
echo -n "LINE: ${LINENO} " && sleep 3 && ods-signer sign --all && sleep 5 &&
echo -n "LINE: ${LINENO} " && syslog_waitfor_count 120 11 'ods-signerd: .*\[STATS\] ods' &&
echo -n "LINE: ${LINENO} " && validns -t $time "$INSTALL_ROOT/var/opendnssec/signed/ods" &&
