...
diff $ignore  $INSTALL_ROOT/var/opendnssec/enforcer/zones.xml zonelist.xml.gold_local &&
...
log_this ods-enforcer-zone_add_1   ods-enforcer zone add --zone ods14 --no-xml &&
log_grep ods-enforcer-zone_add_1   stdout "Imported zone: ods14 into database only, please run \"ods-enforcer zonelist export\" to update zonelist.xml" &&
...
diff $ignore_blank_lines  $INSTALL_ROOT/var/opendnssec/enforcer/zones.xml zonelist.xml.gold_local &&
...
log_this ods-enforcer-zone_del_1  ods-enforcer zone delete -z ods1  --no-xml &&
...
! log_grep ods-enforcer-zone_del_list_1   stdout "Deleted zone: ods1 from database only, please run \"ods-enforcer zonelist export\" to update zonelist.xml" &&
...
log_this ods-enforcer-zone_del_2  ods-enforcer zone delete --zone ods2  &&
#log_grep ods-enforcer-zone_del_1  stdout "zone.*ods1.*deleted successfully"
log_this ods-enforcer-zone_del_list_2   ods-enforcer zone list &&
! log_grep ods-enforcer-zone_del_list_2   stdout "Found Zone: ods2; on policy Policy1" &&
...
log_grep ods-enforcer-zone_del_list_3   stdout "No zones in DB or zonelist." &&
...
log_grep ods-enforcer-zone_add_list_2   stdout "Found Zone: ods0; on policy default" &&
log_grep ods-enforcer-zone_add_list_2   stdout "Found Zone: ods1; on policy Policy1" &&
log_grep ods-enforcer-zone_add_list_2   stdout "Found Zone: ods2; on policy Policy1" &&
log_grep ods-enforcer-zone_add_list_2   stdout "Found Zone: ods3; on policy default" &&
log_grep ods-enforcer-zone_add_list_2   stdout "Found Zone: ods4; on policy default" &&
log_grep ods-enforcer-zone_add_list_2   stdout "Found Zone: ods5; on policy default" &&
log_grep ods-enforcer-zone_add_list_2   stdout "Found Zone: ods6; on policy default" &&
log_grep ods-enforcer-zone_add_list_2   stdout "Found Zone: ods7; on policy default" &&
log_grep ods-enforcer-zone_add_list_2   stdout "Found Zone: ods8; on policy default" &&
log_grep ods-enforcer-zone_add_list_2   stdout "Found Zone: ods9; on policy default" &&
log_grep ods-enforcer-zone_add_list_2   stdout "Found Zone: ods10; on policy default" &&
log_grep ods-enforcer-zone_add_list_2   stdout "Found Zone: ods11; on policy default" &&
log_grep ods-enforcer-zone_add_list_2   stdout "Found Zone: ods12; on policy default" &&
log_grep ods-enforcer-zone_add_list_2   stdout "Found Zone: ods13; on policy default" &&

# Check the export gives the same thing  (note - we use a different gold file here as the order
# in the exported file is not the same as that in the configuration file)
ods-enforcer zonelist export > zonelist.xml.temp_2 &&
