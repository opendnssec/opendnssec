...
log_grep ods-ksmutil-zonetotal_diff_2   	stdout "9 new KSK(s) (2048 bits) need to be created." &&
log_grep ods-ksmutil-zonetotal_diff_2   	stdout "36 new ZSK(s) (2048 bits) need to be created." &&
