...
KSK_CKA_ID_1=`log_grep -o ods-ksmutil-check-1 stdout "ods1.*KSK           publish" | awk '{print $9}'` &&
...
KSK_CKA_ID_2=`log_grep -o ods-ksmutil-check-3 stdout "ods1.*KSK           publish" | awk '{print $9}'` &&
