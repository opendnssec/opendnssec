...
#TEST: This does not run the enforcer at all it only uses the command line to 
#TEST: generate keys. It does so on different policies and checks it generates the right number
...
log_grep ods-ksmutil-default   stdout "1 new KSK(s) (2048 bits) need to be created."  &&
log_grep ods-ksmutil-default   stdout "5 new ZSK(s) (2048 bits) need to be created." &&
...
log_grep ods-ksmutil-zonetotal_same_1   stdout "6 new KSK(s) (2048 bits) need to be created."  &&
log_grep ods-ksmutil-zonetotal_same_1   stdout "9 new ZSK(s) (2048 bits) need to be created."  &&
...
log_grep ods-ksmutil-zonetotal_same_2   stdout "3 new KSK(s) (2048 bits) need to be created."  &&
log_grep ods-ksmutil-zonetotal_same_2   stdout "27 new ZSK(s) (2048 bits) need to be created."  &&
log_this ods-ksmutil-keylist_1a   ods-hsmutil list &&
log_grep ods-ksmutil-keylist_1a   stdout "45 keys found." &&
...
log_grep ods-ksmutil-zonetotal_same_3   stdout "No new KSKs need to be created." &&
log_grep ods-ksmutil-zonetotal_same_3   stdout "35 new ZSK(s) (2048 bits) need to be created."  &&
log_this ods-ksmutil-keylist_2   ods-hsmutil list &&
log_grep ods-ksmutil-keylist_2   stdout "80 keys found." &&
...
log_grep ods-ksmutil-zonetotal_same_4   stdout "No new KSKs need to be created." &&
log_grep ods-ksmutil-zonetotal_same_4   stdout "No new ZSKs need to be created." &&
log_this ods-ksmutil-keylist_2a   ods-hsmutil list &&
log_grep ods-ksmutil-keylist_2a   stdout "80 keys found." &&
...
log_grep ods-ksmutil-zonetotal_diff_1   	stdout "6 new KSK(s) (2048 bits) need to be created."  &&
log_grep ods-ksmutil-zonetotal_diff_1   	stdout "9 new ZSK(s) (2048 bits) need to be created."  &&
...
log_grep ods-ksmutil-zonetotal_diff_2   	stdout "18 new KSK(s) (2048 bits) need to be created." &&
log_grep ods-ksmutil-zonetotal_diff_2   	stdout "27 new ZSK(s) (2048 bits) need to be created." &&
log_grep ods-ksmutil-zonetotal_diff_2   	stdout "all done! " &&
log_this ods-ksmutil-keylist_4   ods-hsmutil list &&
log_grep ods-ksmutil-keylist_4   stdout "60 keys found." &&
...
log_grep ods-ksmutil-zonetotal_standby   	stdout "9 new KSK(s) (2048 bits) need to be created."  &&
log_grep ods-ksmutil-zonetotal_standby   	stdout "9 new ZSK(s) (2048 bits) need to be created."  &&
...
log_grep ods-ksmutil-zonetotal_shared   stdout "2 new KSK(s) (2048 bits) need to be created."  &&
log_grep ods-ksmutil-zonetotal_shared   stdout "2 new ZSK(s) (2048 bits) need to be created."  &&
...
log_grep ods-ksmutil-zonetotal_shared_1   stdout "No new KSKs need to be created."  &&
log_grep ods-ksmutil-zonetotal_shared_1   stdout "3 new ZSK(s) (2048 bits) need to be created."  &&
log_this ods-ksmutil-keylist_7   ods-hsmutil list &&
log_grep ods-ksmutil-keylist_7   stdout "7 keys found." &&
...
log_grep ods-ksmutil-zonetotal_shared_2   stdout "2 new KSK(s) (1024 bits) need to be created."  &&
log_grep ods-ksmutil-zonetotal_shared_2   stdout "2 new ZSK(s) (2048 bits) need to be created."  &&
log_this ods-ksmutil-keylist_8   ods-hsmutil list &&
log_grep ods-ksmutil-keylist_8   stdout "11 keys found." &&
...
log_grep ods-ksmutil-zonetotal_shared_3   stdout "1 new KSK(s) (1024 bits) need to be created."  &&
log_grep ods-ksmutil-zonetotal_shared_3   stdout "2 new ZSK(s) (2048 bits) need to be created."  &&
