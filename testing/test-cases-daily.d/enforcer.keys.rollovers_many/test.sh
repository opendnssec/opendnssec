...
# log_grep ods-ksmutil-setup_zone_and_keys   stdout "This will create 10 KSKs" &&ods1.
...
ZSK_CKA_ID_1=`log_grep -o ods-ksmutil-check-0 stdout "ZSK           active" | awk '{print $6}'` &&
ZSK_CKA_ID_2=`log_grep -o ods-ksmutil-check-0 stdout "ZSK           publish" | awk '{print $6}'` &&
KSK_CKA_ID_STANDBY=`log_grep -o ods-ksmutil-check-0 stdout "KSK           dssub" | awk '{print $7}'` &&
KSK_CKA_ID_1=`log_grep -o ods-ksmutil-check-0 stdout "KSK           publish" | awk '{print $6}'` &&
...
ZSK_CKA_ID_3=`log_grep -o ods-ksmutil-check-2 stdout "ZSK           publish" | awk '{print $6}'` &&
...
KSK_CKA_ID_2=`log_grep -o ods-ksmutil-check-4 stdout "KSK           publish" | awk '{print $6}'` &&
...
ZSK_CKA_ID_4=`log_grep -o ods-ksmutil-check-5 stdout "ZSK           publish" | awk '{print $6}'` &&
...
ZSK_CKA_ID_5=`log_grep -o ods-ksmutil-check-8 stdout "ZSK           publish" | awk '{print $6}'` &&
KSK_CKA_ID_3=`log_grep -o ods-ksmutil-check-8 stdout "KSK           publish" | awk '{print $6}'` &&
