...
ZSK_ODS_1=`log_grep -o ods_key_list1 stdout "ods .*ZSK           active" | awk '{print $6}'` &&
ZSK_ODS1_1=`log_grep -o ods_key_list1 stdout "ods1 .*ZSK           active" | awk '{print $6}'` &&
ZSK_ODS2_1=`log_grep -o ods_key_list1 stdout "ods2 .*ZSK           active" | awk '{print $6}'` &&
