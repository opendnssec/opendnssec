...
KSK_CKA_ID_1=`log_grep -o ods-ksmutil-cka_id1 stdout "ods1                            KSK           publish" | awk '{print $9}'` &&
KSK_CKA_ID_2=`log_grep -o ods-ksmutil-cka_id1 stdout "ods2                            KSK           publish" | awk '{print $9}'` &&
...
KSK_CKA_ID_3=`log_grep -o ods-ksmutil-cka_id9 stdout "ods1                            KSK           publish" | awk '{print $9}'` &&
